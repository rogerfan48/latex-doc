...
% \docheader{Custom Header}       % 選填，homework/note 樣式的頁首左邊文字（homework 預設 subtitle；note 預設 title）

% ====== STYLE ======
% 可用樣式：academic / homework / note / minimal / custom
%   academic — 標題置中，section 有底線有編號，頁尾頁碼
%   homework — 標題左右對齊（標題+課名 左，日期+姓名 右），section 無編號，頁首左=\docheader（預設 subtitle）右=姓名
%   note     — 標題靠左（24pt），subtitle + author · date inline，hrule，section 有底線有編號，頁首左=\docheader（預設 title）右=姓名
